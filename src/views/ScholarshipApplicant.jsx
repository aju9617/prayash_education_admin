...
import { scholarshipApplicantService } from "@services";
...
function ScholarshipApplicant() {
  ...
  React.useEffect(() => {
    async function fetch() {
      setFetching(true);
      const res = await scholarshipApplicantService.getList();
      if (res.status) {
        setList(res.data);
    ...
    <div className=" ">
      <div className="mb-6">
        <h2 className="text-xl flex items-center justify-between  font-medium text-gray-700 mb-2">
          ...
          <button
            onClick={scholarshipApplicantService.downloadExcel}
          ...
          >
            <thead>
              <tr className="text-sm  !font-medium bg-primary text-white">
                ...
                <td className="p-2 px-4 whitespace-nowrap">DOB</td>
                ...
                <td className="p-2 px-4 whitespace-nowrap">Center</td>
